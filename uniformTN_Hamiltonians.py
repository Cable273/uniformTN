...
class twoBodyH(localH_term):
    ...
    #2d left
    def exp_2d_left(self,psi):
        return self.exp_2d_left_hori(psi) + self.exp_2d_left_vert(psi)
    def exp_2d_left_hori(self,psi):
    ...
    #2d left biparite
    def exp_2d_2body_horizontal_leftBip_ind(self,mps1,mps2,mpo1,mpo2,T1,T2,R1):    
        ...
        return E
    def exp_2d_2body_vertical_leftBip_ind(self,mps1,mps2,mpo1,mpo2,T1,RR2):
    ...
    def exp_2d_2body_horizontal_leftBip(self,psi):
        E = self.exp_2d_2body_horizontal_leftBip_ind(psi.mps1,psi.mps2,psi.mpo1,psi.mpo2,psi.T1,psi.T2,psi.R1)
        E += self.exp_2d_2body_horizontal_leftBip_ind(psi.mps2,psi.mps1,psi.mpo2,psi.mpo1,psi.T2,psi.T1,psi.R2)
        return E/2

    def exp_2d_2body_vertical_leftBip(self,psi):
        E =  self.exp_2d_2body_vertical_leftBip_ind(psi.mps1,psi.mps2,psi.mpo1,psi.mpo2,psi.T1,psi.RR2)
        E +=  self.exp_2d_2body_vertical_leftBip_ind(psi.mps2,psi.mps1,psi.mpo2,psi.mpo1,psi.T2,psi.RR1)
        return E/2

    def exp_2d_left_bipartite(self,psi):
        return self.exp_2d_2body_horizontal_leftBip(psi) + self.exp_2d_2body_vertical_leftBip(psi)
